...
const TOOLS = [
  ...
  },
  {
    ...
    description: "Detect unusual movement in a metric for the latest period versus recent baseline.",
    parameters: {
      type: "object",
      properties: {
        question: {
          type: "string",
          description: "A question like 'Any unusual markets this week for completed jobs?' or 'Detect anomalies in revenue'.",
        },
      },
      required: ["question"],
      additionalProperties: false,
